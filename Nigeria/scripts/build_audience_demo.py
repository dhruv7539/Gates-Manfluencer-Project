...
sources, OP handle. The shared pipeline:
  ...
  9. Output:
       Nigeria/Audience Analysis/Audience Comments - Final/<creator>_<slug>.xlsx  (single `text` col)
...
RAW_ROOT = ROOT / "Nigeria/Audience Analysis/Audience Comments - Raw"
KEYWORDS_XLSX = ROOT / "Proposed Keywords & Codebooks" / "NLC Proposed keywords.xlsx"
OUTPUT_DIR = ROOT / "Nigeria/Audience Analysis/Audience Comments - Final"
        ...
        "posts": [
            {
                ...
                "out_name": "Agba John Doe_Never Leave Marriage Because Husband Cheated.xlsx",
            },
            {
                ...
                "out_name": "Shola_7 Women Will Beg One Man to Marry.xlsx",
            },
        ],
    },
    "deyemi": {
        ...
        "posts": [
            {
                ...
                "out_name": "Deyemi Okanlawon_Stop Raping Women Response.xlsx",
            },
        ],
    },
    "banky": {
        ...
        "posts": [
            {
                ...
                "out_name": "Banky Wellington_MENtality Podcast.xlsx",  # all 6 pooled into one file
            }
            for ep in [
                "Masculinity + Money",
