...
7. **Export** to `Nigeria/Audience Analysis/Audience Comments - Final/<Creator>/<Post>.xlsx`.
8. **Report plots**.
...
CELLS.append(code("""INPUT_DIR = ROOT / "Nigeria/Audience Analysis/Audience Comments - Raw"
...
- Final per-post selections live in `Nigeria/Audience Analysis/Audience Comments - Final/<Creator>/<Post>.xlsx` plus `_summary.xlsx`.
